...
public class ToolForgeMenu extends AbstractContainerMenu {
    public final ToolForgeBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public ToolForgeMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
    ...
    public int getScaledProgress() {
        ...
        int progressArrowSize = 142; // This is the height in pixels of your arrow
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.TOOL_FORGE.get());
    }
