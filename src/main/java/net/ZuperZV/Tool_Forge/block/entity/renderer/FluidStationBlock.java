...
import net.ZuperZV.Tool_Forge.util.RenderUtil;
...
public class FluidStationBlock implements BlockEntityRenderer<ToolStationBlockEntity> {
    public FluidStationBlock(BlockEntityRendererProvider.Context context) {

    }

    @Override
    public void render(ToolStationBlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight,
                       int packedOverlay) {
