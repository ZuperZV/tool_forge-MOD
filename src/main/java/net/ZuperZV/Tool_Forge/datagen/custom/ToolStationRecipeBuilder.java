package net.ZuperZV.Tool_Forge.datagen.custom;
...
public class ToolStationRecipeBuilder implements RecipeBuilder {
    ...
    public ToolStationRecipeBuilder(ItemLike ingredient, ItemLike result, int count, int craftTime, FluidStack fluidStack) {
    ...
    public static class Result implements FinishedRecipe {
        ...
        public ResourceLocation getId() {
            return new ResourceLocation(Tool_Forge.MOD_ID,
                    ForgeRegistries.ITEMS.getKey(this.result).getPath() + "_in_tool_station");
        }

        @Override
        public RecipeSerializer<?> getType() {
            return ToolStationRecipe.Serializer.INSTANCE;
        }
