...
import net.ZuperZV.Tool_Forge.entity.ai.SoulAttackGoal;
...
public class SoulEntity extends Animal {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new SoulAttackGoal(this, 1.0D, true));
    ...
    private void setupAnimationStates() {
        ...
        if(this.isAttacking() && attackAnimationTimeout <= 0) {
            attackAnimationTimeout = 6; // Length in ticks of your animation
